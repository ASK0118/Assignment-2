							...
							if(day<=7) {  //start for day less or equal to 7
								...
								System.out.println("The total rental price 		: RM "+ df2.format(totPrice));
									...
									if(day<=7) {  //start for day less or equal to 7
										...
										this.RentPrice= CRV.Rentprice(selection,choose,day);  // price for CRV if rent less than or equal 7 days
										...
										this.RentPrice= CRV.Rentprice(selection,choose,day);  //new price for CRV if rent more than 7 days 
